...
/*   Updated: 2024/01/21 11:14:28 by avoronko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

int	ft_check_initialization(t_args *args, t_data *data, pthread_t *observer, char **av)
{
...
int	av_second_check(char **av)
{
	...
	{
		early_error("Error: Invalid number of times each philosopher must eat\n");
		return (1);
	}
	return (0);
}
